...
<asp:Content ID="Content4" ContentPlaceHolderID="formPlaceHolder" Runat="Server">
    <h2>Profile</h2>
    <div id="side-navBar">
        <asp:HyperLink NavigateUrl="~/Admin/MaintenancePage.aspx" class="sideLinks" ID="accDetails" runat="server" ForeColor="#FF0066">Account Details</asp:HyperLink> <br />
    ...
    <div id="accountDetails">
        ...
        <asp:Label ID="role_lbl" CssClass="profile_lbls" runat="server" Text="Role: "></asp:Label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        <asp:Label ID="role_lbl2" runat="server"></asp:Label>
    </div>
</asp:Content>

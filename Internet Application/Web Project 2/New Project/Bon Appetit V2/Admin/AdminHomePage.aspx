...
<asp:Content ID="Content2" ContentPlaceHolderID="formPlaceHolder" Runat="Server">
    ...
    <section class="main items">
	    <article class="item">
		    <header>
			    <a href="../Admin/AdminMenu.aspx"><img src="../images/burg.jpg" width="100%"; alt="" /></a>
		    ...
		    <ul class="actions">
			    <li><a href="../Admin/AdminMenu.aspx" class="button">More</a></li>
		    </ul>
	    </article>
	    <article class="item">
		    <header>
			    <a href="../Admin/AdminMenu.aspx"><img src="../images/pink.jpeg" width="100%" alt="" /></a>
	    ...
	    <article class="item">
		    <header>
			    <a href="../Admin/AdminMenu.aspx"><img src="../images/cherryD.jpeg" width="100%" alt="" /></a>
	    ...
	    <article class="item">
		    <header>
			    <a href="../Admin/AdminMenu.aspx"><img src="../images/veg4.jpeg" width="100%" alt="" /></a>
			    <h3>Vegeterian</h3>
		    </header>
		    <p>Fusce malesuada efficitur venenatis. Pellentesque tempor leo sed massa hendrerit hendrerit. In sed feugiat est, eu congue elit. Ut porta magna vel felis sodales vulputate. Donec faucibus dapibus lacus non ornare.</p>
		    <ul class="actions">

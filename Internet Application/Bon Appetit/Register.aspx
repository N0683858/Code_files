...
<asp:Content ID="Content2" ContentPlaceHolderID="formPlaceHolder" Runat="Server">
    <asp:CreateUserWizard ID="CreateUserWizard1" runat="server" BorderColor="#FFDFAD" BorderStyle="Solid" BorderWidth="1px" Font-Names="Verdana" Font-Size="1em" Width="654px" ContinueDestinationPageUrl="~/Default.aspx" OnCreatedUser="CreateUserWizard1_CreatedUser">
        ...
        <WizardSteps>
            <asp:CreateUserWizardStep runat="server" >
                <ContentTemplate>
                    <table style="font-family:Verdana;font-size:100%;width:654px;">
                        <tr>
                            <td align="center" colspan="2" style="color:White;background-color:#333333;font-weight:bold;">Sign Up for Your New Account</td>
                        </tr>
                        <tr>
                            <td align="right">
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:Database %>" SelectCommand="SELECT * FROM [Customers]"></asp:SqlDataSource>
</asp:Content>

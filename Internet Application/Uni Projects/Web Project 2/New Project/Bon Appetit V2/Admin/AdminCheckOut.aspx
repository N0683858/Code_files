<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminMasterPage.master" AutoEventWireup="true" CodeFile="AdminCheckOut.aspx.cs" Inherits="Admin_AdminCheckOut" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="formPlaceHolder" Runat="Server">
     <h1>CheckOut</h1>
        ...
        <asp:Button ID="lbtnContinueShopping" Text="Continue Shopping" runat="server"
            PostBackUrl="~/Admin/AdminOrder.aspx" CausesValidation="False" Width="262px" />
</asp:Content>
